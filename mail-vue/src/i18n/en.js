const en = {
    ...
    apiResponse: 'Response Example',
    apiExample: 'Example Code',
    apiEndpointDesc: 'Get emails from specified mailbox',
    apiKeyHeaderDesc: 'Use generated API key for authentication',
    emailParamDesc: 'Target email address',
    limitParamDesc: 'Limit number of emails returned, default 10',
    afterTimeParamDesc: 'Get emails after this time, format: YYYY-MM-DD HH:mm:ss',
    ...
    disabled: 'Disabled',
    generate: 'Generate',
    expireDaysDesc: 'Valid Days',
    expireDaysTip: 'Set to 0 for never expire',
    generateSuccessMsg: 'API key generated successfully',
    date: 'Date',
    roleDesc: 'Role',
