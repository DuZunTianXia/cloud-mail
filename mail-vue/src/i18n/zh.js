const zh = {
    ...
    apiResponse: '响应示例',
    apiExample: '示例代码',
    apiEndpointDesc: '获取指定邮箱的邮件',
    apiKeyHeaderDesc: '使用生成的API密钥进行身份验证',
    emailParamDesc: '目标邮箱地址',
    limitParamDesc: '返回邮件数量限制，默认10',
    afterTimeParamDesc: '获取此时间之后的邮件，格式：YYYY-MM-DD HH:mm:ss',
    curlExample: 'cURL示例',
    pythonExample: 'Python示例',
    ...
    apiKey: 'API密钥',
    apiKeyName: '密钥名称',
    apiKeyNameRequired: '密钥名称不能为空',
    noApiKeyFound: '没有任何API密钥',
    createTime: '创建时间',
    expireTime: '过期时间',
    lastUsed: '最后使用',
    neverExpire: '永不过期',
    ...
    generate: '生成',
    expireDaysDesc: '有效天数',
    expireDaysTip: '设置为0表示永不过期',
    generateSuccessMsg: 'API密钥生成成功',
    date: '时间',
    roleDesc: '权限身份',
    noSubject: '无主题',
    recipient: '收件人',
